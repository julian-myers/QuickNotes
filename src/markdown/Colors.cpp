...
void initColorPairs(const Config::Config &config) {
  ...
  init_pair(PAIR_HEADING_3, COLOR_HEADING_3, COLOR_HEADING_BG);
  init_pair(PAIR_HEADING_4, COLOR_HEADING_4, COLOR_HEADING_BG);
  init_pair(PAIR_HEADING_5, COLOR_HEADING_5, COLOR_HEADING_BG);
  init_pair(PAIR_HEADING_6, COLOR_HEADING_6, COLOR_HEADING_BG);
